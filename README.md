...
> **Personal fork notes:** I'm using this primarily to experiment with `orchestrate`, `continual-learning`, and `cli-for-agent`. PRs/issues should go to the upstream repo at [cursor/plugins](https://github.com/cursor/plugins).
